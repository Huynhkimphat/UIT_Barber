...
DELETE FROM CTHDDV;
DELETE FROM HOADON
INSERT INTO HOADON(MAHD, MAKH, NGAY, TONGTIEN, THANHTOAN) VALUES(MAHD_SEQ11.NEXTVAL,4,To_Date('27/06/2021','dd-mm-yyyy'),270000,0);
INSERT INTO CTHDDV(MAHD,MADV,MADL) VALUES(MAHD_SEQ11.CURRVAL,1,1);
